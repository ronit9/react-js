      ...
      <section className="addcart">
        <Container fluid className="text-center p-5 ">
          <div className="cart-container">
            ...
            <div className="cart-text">Your watchlist</div>
          </div>
          <Row className="align-items-center ">
            {cart.map((val, index) => {
              const { id, Title, Poster, Year } = val;
                ...
                <Col md={3} key={index}>
                  <div className="book m-3">
                    <div className="info ">
                      ...
                      <p className="mb-1 text-secondary">Year: {Year}</p>
                      <p className="mb-2 text-muted small">Movie ID: {id}</p>
